 ...
 */
@WebServlet(name = "getListSPtheoMenu", urlPatterns = {"/getListSPtheoMenu"})
public class getListSPtheoMenu extends HttpServlet {
...
//                int id = Integer.parseInt(request.getParameter("nhapid"));
                ArrayOfSanPham list = getListSanPham();
    ...
    public static ArrayOfSanPham getListSanPhamTheoMenu(int mamenu) {
        ...
        return port.getListSanPhamTheoMenu(mamenu);
    }

    public static ArrayOfSanPham getListSanPham() {
        com.client.service.Service service = new com.client.service.Service();
        com.client.service.ServiceSoap port = service.getServiceSoap();
        return port.getListSanPham();
    }
