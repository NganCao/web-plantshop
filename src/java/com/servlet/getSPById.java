 ...
 */
@WebServlet(name = "getSPById", urlPatterns = {"/getSPById"})
public class getSPById extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(action.equals("lay")){
                ...
                com.client.service.SanPham result = getSanPham(id);
                
                out.print("masp: \n" + result.getMaSP()+ "<br>") ;
                out.print("tensp: \n" + result.getTenSP()+ "<br>");
                out.print("gia: \n" + result.getGia()+ "<br>");
                out.print("<img src='" + result.getHinhAnh() + "' /><br><hr>");
            }
        }
    }
